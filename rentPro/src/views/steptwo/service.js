...
//     })
  ...
  // getAttributes(callback,pms) {
  //   http.get('api/game/getAttrbutes',{params:pms})
  //   .then(function (response) {
  //     // console.log(response)
  ...
  // },
  getAttributes(callback,pms) {
    http.post('api/game/getAttrbutes',pms)
    .then(function (response) {
      // console.log(response)
        callback(response.data)
    })
  ...
  release(callback,pms) {
    http.get('api/game/release',{params:pms})
    .then(function (response) {
      // console.log(response)
        callback(response.data.data)
    })
